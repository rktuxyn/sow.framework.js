...
Sow.Run( function () {
    var _next = function ( next, n ) {
        ...
        location.href = "/urlroute";
        return;
    },
    _checkXHR = function ( jqXHR ) {
        var status_code = jqXHR.getResponseHeader( "x-http-status-code" );
        if ( status_code === "403" ) {
            alert( "You already authenticate." );
                    ...
                    return {
                        ...
                        ready: function ( a ) {
                            ...
                            $( 'form button' ).on( 'click', function ( e ) {
                                ...
                                $owner.attr( 'disabled', true ).append( '<img src="/images/indicator__r.gif"/>' ); $gmsgP.css( 'display', "none" );
                                var $frm = $( 'form input[data-type="text"]' );
                                require( 'Sow.Net.Web.Validate' ).reset( $frm, function () {
                                    this.validate( $frm, function ( isErr, obj ) {
                                        if ( isErr ) {
                                            $owner.removeAttr( 'disabled' ).find( "img" ).remove(); $owner = $gmsg = undefined;
                                            return;
                                        }
                                        obj.param_type = this.isEmail( obj.value ) ? "email" : "user";
                                        require( 'Sow.Net.Web.XHR' ).xhr( {
                                            type: "get",
                                            url: String.format( "/app/api/web_auth/sginin/?def={0}&ckey={1}", encodeURIComponent( JSON.stringify( obj ) ), $( '#g-recaptcha-response' ).val() ),
                                            dataType: 'json',
                                            ...
                                            $owner.removeAttr( 'disabled' ).find( "img" ).remove(); $owner = undefined;
                                            if ( data.ret_val === -501 || data.ret_val === -200 ) {
                                            ...
                                            if ( data.ret_val === -550 ) {
                                                {
                                                    ...
                                                    for ( let ix = 0, xl = arr.length; ix < xl; ix++ ) {
                                                        let karr = _MSG[String( arr[ix] )];
                                            ...
                                            if ( !_checkXHR( jqXHR ) ) return;
                                            console.log( textStatus );
                                            $owner.removeAttr( 'disabled' ).find( "img" ).remove();
                    ...
                    return {
                        ...
                        ready: function ( a ) {
                            ...
                            var _MSG = {
                                ...
                                "-10311": ['email', 'This @Email Exists Our System !'],
                                "-10312": ['email', 'This @Email Exists Our System !'],
                            ...
                            _module.Closure( function () {
                                    ...
                                    commonKeyup: this.aggregate( function () {
                                        ...
                                        return function ( $el, task ) {
                                            ...
                                            _coW.xhr[task] = require( 'Sow.Net.Web.XHR' ).xhr( {
                                                type: "get",
                                                url: String.format( "/app/api/web_auth/input/keyup/?task_type={0}&sp=___check__key_up&def={1}", task_type, encodeURIComponent( JSON.stringify( { value: val } ) ) ),
                                                dataType: 'json',
                                                xhrFields: { withCredentials: true }
                                            } ).done( function ( data ) {
                                ...
                                var _execute = {
                                    request: function ( $owner, cb ) {
                                        ...
                                        $owner.attr( 'disabled', true ).append( '<img src="/images/indicator__r.gif"/>' );
                                        $gmsgP.css( 'display', "none" );
                                        ...
                                        require( 'Sow.Net.Web.Validate' ).reset( $frm, function () {
                                            this.validate( $frm, function ( isErr, obj ) {
                                                ...
                                                require( 'Sow.Net.Web.XHR' ).xhr( {
                                                    type: "get",
                                                    url: String.format( "/app/api/web_auth/sginup/?def={0}&ckey={1}", encodeURIComponent( JSON.stringify( obj ) ), $( '#g-recaptcha-response' ).val() ),
                                                    dataType: 'json',
                                                    xhrFields: { withCredentials: true }
                                                } ).done( function ( data ) {
                                                    $gmsg.html( "" );
                        ...
                        ready: function ( a ) {
                            ...
                            var fp_worker = {
                                confirm: function ( $owner, $gmsg ) {
                                    $owner.append( '<img src="/images/indicator__r.gif"/>' );
                                    require( 'Sow.Net.Web.XHR' ).xhr( {
                                        type: "GET",
