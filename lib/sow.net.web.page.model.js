                    ...
                    return {
                        renderer: module.aggregate( function () {
                            ...
                            return {
                                getTemplate: function ( templ, cb ) {
                                    if ( typeof ( cb ) !== 'function' )
                                        throw new TypeError( "Invalid instance defined instead of Function" );
                                    if ( !templ ) {
                                        templ = '_default.tmpl';
                                    }
                                    if ( _template[templ] ) {
                                    ...
                                    require( 'Sow.Net.Web.XHR' ).xhr( {
                                        ...
                                        footer = footer
                                            ...
                                            .replace( /\\t/gi, " " )
                                            .replace( /\s+/gi, " " )
                                            .replace( /float:right;/gi, "" )
                                            .replace( /id="privacy_gurd"/gi, "" )
                                            ;
                                        _template[templ] = data.replace( /{__footer__info__here__}/gi, footer ); data = undefined;
                                        Sow.async( function () {
                                            cb.call( require( 'Renderer' ).renderer, "SUCCESS", _template[templ] );
                                        }, 0 );
                                        return this;
                                    } ).fail( function ( xhr, s, t, a ) {
                                        let xres = Sow.onXHRError( xhr, 401 );
                                        if ( xres.fw !== true ) return;
                                        if ( xres.status_code < 0 ) console.elog( xres.emsg );
                                        console.log( xres.status_description || t );
                            ...
                            return {
                                openNew: function ( opt ) {
                                    ...
                                    $.ajax( {
                                            ...
                                            let config = {
                                                ...
                                                close: function () {
                                                    ...
                                                    Sow.hook( "__web__page" ).fire( "before_route_change", [opt.url, function () {
                                                        ...
                                                        console.log( String.format( "✔ %cClosed==>{0}", opt.url ), "font-weight: bold; font-style:italic; color:#2196f3;" );
                                                        opt = undefined;
                                                    }] );
                                                }
                                            };
                                        ...
                                        return;
                                    } ).fail( function ( jqXHR, textStatus, thrown, error ) {
                                        let xres = Sow.onXHRError( jqXHR, 401 );
                                        if ( xres.fw !== true ) return;
                                        if ( xres.status_code < 0 ) console.elog( xres.emsg );
                                        Sow.loader.hide();
                                        console.log( xres.status_description || thrown );
                                        opt.fail();
                                    } );
                                }
                            };
                            ...
                            return {
                                ...
                                get_route_ctx: function ( route, check ) {
                                    if ( check === true ) return __pages[route] ? true : false;
                                    ...
                                    var _iWorker = {
                                        ...
                                        confirm: function ( cfg ) {
                                            if ( typeof ( cfg ) !== 'object' )
                                                throw new TypeError( "Invalid instance defined instead of Object" );
                                            $.confirm( {
                                            ...
                                            $el.not( $el.not( '[type="checkbox"]' ).each( function () {
                                                ...
                                                if ( dsm[prop] ) {
                                                    ...
                                                    if ( drop_source === null || typeof ( drop_source ) !== "object" )
                                                        return;
                                                    if ( $inst[0] && $inst[0].selectize ) {
                                                        $inst[0].selectize.___renew_options( drop_source, true );
                                                    } else {
                                                        $inst.html( _iWorker.createDropdown( drop_source ) );
                                                    }
                                                }
                                                let val = obj[prop];
                                                ...
                                                detailEvent: function ( $elm, key, navigator, req ) {
                                                    $( '[data-body-part="result"]', $elm ).on( 'click', function ( e ) {
                                                        ...
                                                        if ( $parent.hasClass( "toggle" ) ) {
                                                            ...
                                                            Sow.hook( key ).firea( "__on_detail_table_toggle_change", $el, $el.closest( "tr" ), $el.closest( "td" ) );
                                                            return;
                                                        }
                                                        if ( $parent.hasClass( "checkbox" ) ) {
                                                            $parent.exit(); $parent = undefined;
                                                            if ( $el.prop( "type" ) !== "checkbox" ) return;
                                                            Sow.hook( key ).firea( "__on_detail_table_checkbox_change", $el, $el.closest( "tr" ), $el.closest( "td" ) );
                                                            return;
                                                        }
                                                        e.preventDefault();
                                                        Sow.async( function () {
                                        ...
                                        validate: this.aggregate( function () {
                                            var validate_worker = {
                                                ...
                                                process: function ( val, $inst ) {
                                                    ...
                                                    if ( typeof ( this[rules.m] ) !== 'function' )
                                                        throw new TypeError( "Invalid method defined ==>" + rules.m );
                                                    let ret = 0;
                                            ...
                                            return {
                                                all: function ( $el, allow_invalid ) {
                                                    let count = 0, out = {};
                                                    $el.not( $el.not( '[type="checkbox"]' ).each( function () {
                                                        let $inst = $( this );
                                                        let val = $inst.val();
                                                        count += validate_worker.process( val, $inst );
                                                        if ( count >= 0 && allow_invalid !== true ) {
                                                    ...
                                                    if ( count < 0 && allow_invalid !== true ) return null;
                                                    return out;
                                                },
                                                keyup: function ( $el ) {
                                        ...
                                        notification: {
                                            ...
                                            show: function ( $el, msg, cls, interval ) {
                                                ...
                                                switch ( cls ) {
                                                    ...
                                                    default: throw new TypeError( "Invalid class defined# " + cls );
                                                }
                                        ...
                                        print_preview: function ( settings ) {
                                            ...
                                            if ( !settings.url ) throw new TypeError( "Url not defined!!!" );
                                            ...
                                            if ( typeof ( settings.self_print ) !== "boolean" )
                                                settings.self_print = true;

                                            if ( settings.self_print === true ) {
                                                settings.url += "&self_print=true";
                                            }
                                            window.open( settings.url, settings.name || ( Sow.App.name + "-Print window" ), "_blank" );
                                        },
                                    ...
                                    return function ( route, $elm, __cb, isdialog, ___$ui, __container_key ) {
                                        ...
                                        this.getTemplate( __pages[route].reg.template, function ( s, d ) {
                                            ...
                                            Object.extend( _pages, {
                                                require: function ( fn, b ) {
                                                    let ftype = typeof ( fn );
                                                    if ( 'string' === ftype ) {
                                                        return require( fn, b );/**Assume this is public namespace name*/
                                                    }
                                                    if ( 'function' !== ftype )
                                                        throw new TypeError( "Invalid instance defined instead of Function" );
                                                    if ( typeof ( _pages ) === 'undefined' ) {
                                                        console.info( "page context disposed!!!" );
                                                        /*page disposed*/
                                                        return false;
                                                    };
                                            ...
                                            let __inf = this.render( typeof ( _pages.fm ) === 'function' ? _pages.fm.call( _pages, _pages.require ) : _pages.fm, $elm );
                                            delete _pages.fm;
                                            ...
                                            Object.extend( _pages, {
                                                ...
                                                enable_disable: function ( t, field ) {
                                                    ...
                                                    for ( let i = 0, l = field.length; i < l; i++ ) {
                                                        ...
                                                        if ( $elm[0] && typeof ( $elm[0].selectize ) !== 'undefined' )
                                                            $elm[0].selectize[t]();
                                                        else
                                                ...
                                                dump_obj: function ( obj ) {
                                                    if ( obj === null || typeof ( obj ) !== 'object' )
                                                        throw new TypeError( "Argument should be Object instance!!!" );
                                                    for ( let p in obj ) {
                                                        if ( !this.elements[p] ) continue;
                                                        let $elm = this.elements[p].$elm;
                                                        if ( typeof ( obj[p] ) === "function" ) {
                                                            obj[p].call( $elm ); continue;
                                                        }
                                                        if ( $elm[0] && typeof ( $elm[0].selectize ) !== 'undefined' ) {
                                                ...
                                                onTransportRequest: function ( request ) {
                                                    if ( request === null || typeof ( request ) !== 'object' )
                                                        throw new TypeError( "request should be object!!!" );
                                            ...
                                            if ( typeof ( _pages.cmd.s ) !== "object" ) _pages.cmd.s = {};
                                            Object.extend( _pages, {
                                                drop_srch_map: {},
                                                ...
                                                create_query: function ( obj ) {
                                                    return _iWorker.create_query.call( this, obj );
                                                },
                                                getElem: function () {
                                                    return $elm;
                                                },
                                                $waiter: function () {
                                                    throw new Error( "Use Sow.loader.show() instead of $waiter" );
                                                },
                                                postmortem: function () {
                                                    Sow.Notify.hideAll();
                                                    console.log( String.format( "✔ %cRemove context for {0}! ", this.reg.route ), "font-weight: bold; font-style:italic; color:#2196f3;" );
                                                    for ( let p of this.dispose_prop ) {
                                                        if ( !this.elements[p.key] ) continue;
                                                        if ( p.type === "selectize" ) {
                                                            let $e = this.elements[p.key].$elm;
                                                            if ( $e[0] && typeof ( $e[0].selectize ) !== 'undefined' )
                                                    ...
                                                    $( '.datepicker', $elm ).datepicker( "destroy" ).off();
                                                    $( '*', $elm ).off();
                                                    console.log( "✔ %cAll event destroyed from Current context! ", "font-weight: bold; font-style:italic; color:#2196f3;" );
                                                    if ( isdialog && ___$ui ) {
                                                        ___$ui.destroy();
                                                        ___$ui.___destroy();
                                                        $elm.remove();
                                                        ...
                                                        $elm.children().remove();
                                                    $elm.exit();
                                                    Sow.hook( "__web__page" ).firea( "__on_dispose", route );
                                                    _pages = route = ___$ui = isdialog = $elm = __cb = undefined;
                                                    console.log( "✔ %cCurrent context destroyed!", "font-weight: bold; font-style:italic; color:#2196f3;" );
                                                    return {};
                                                },
                                                dispose_prop: [],
                                                set_dispose_prop: function ( key, type ) {
                                                    if ( typeof ( key ) === "object" ) {
                                                        if ( !$.isArray( key ) ) {
                                                            let e = new TypeError( "Invalid argument defined!!!" );
                                                            console.elog( e );
                                                            throw e;
                                                        }
                                                        for ( let i = 0, l = key.length; i < l; i++ ) {
                                                            ...
                                                            for ( let p in pop ) {
                                                                let xy = pop[p];
                                                                for ( let x = 0, xl = xy.length; x < xl; x++ ) {
                                            ...
                                            Object.extend( _pages, {
                                                ...
                                                validate: function ( $arg, allow_invalid ) {
                                                    if ( $arg instanceof $ ) {
                                                        return _iWorker.validate.all( $arg, allow_invalid );
                                                    }
                                                    return _iWorker.validate.all( $( '[data-field-key]', $elm ).not( '[data-not-validate]' ), allow_invalid );
                                                },
                                                validateKeyup: function ( $arg, async ) {
                                                    if ( !( $arg instanceof $ ) )
                                                        throw new TypeError( "Argument should be jQuery instance!!!" );
                                                ...
                                                _xhr: function ( cfg, s, e ) {
                                                    return $.ajax( cfg ).done( function ( data, status, xhr ) {
                                                        ...
                                                        let xres = Sow.onXHRError( jqXHR, 401, textStatus );
                                                        if ( xres.fw !== true ) return;
                                                        if ( xres.status_code < 0 ) console.elog( xres.emsg );
                                                        e.call( _pages, {
                                                            error: true,
                                                            ...
                                                            response: xres.status_description || error
                                                        } );
                                                    } );
                                                },
                                                xhr: function ( cfg ) {
                                                    ...
                                                    return _iWorker.xhr.post( {
                                                        ...
                                                        fail: function ( jqXHR, textStatus, error ) {
                                                            if ( textStatus == "abort" ) {
                                                                if ( typeof ( cfg.abort ) === "function" ) {
                                                                    cfg.abort.call( this, jqXHR, textStatus, error );
                                                                    return;
                                                                }
                                                            }
                                                ...
                                                populateDetail: function ( data, cb, $owner ) {
                                                    ...
                                                    if ( typeof ( this.reg.info.search_detail.beforeRender ) === 'function' )
                                                        this.reg.info.search_detail.beforeRender.call( this, data );
                                                    Sow.async( function () {
                                                        let rfn = {
                                                            fn: function ( resp ) {
                                                                if ( !( $owner instanceof $ ) ) {
                                                                ...
                                                                $owner.htmla( resp );
                                                                if ( _pages.reg.info.search_detail.tablesorter === true ) {
                                                                    $( "table", $owner ).tablesorter();
                                                                }
                                                                //$owner.exit();
                                                                //$owner = undefined;
                                                                if ( typeof ( _pages.reg.info.search_detail.onRender ) === 'function' )
                                                                    _pages.reg.info.search_detail.onRender.call( _pages, _pages.require, $owner );
                                                                cb.call( _pages, "SUCCESS", $owner );
                                                            },
                                                            run: function () {
                                                        ...
                                                        if ( this.Web.Template.script.has( tname ) ) {
                                                            ...
                                                            $.ajax( {
                                                                ...
                                                                if ( xres.fw !== true ) return;
                                                                if ( xres.status_code < 0 ) console.elog( xres.emsg );
                                                                console.log( xres.status_description || error );
                                            ...
                                            if ( typeof ( _pages.reg.info.search_detail ) === "function" ) {
                                                _pages.reg.info.search_detail = _pages.reg.info.search_detail.call( _pages, _pages.require );
                                            }
                                            Object.extend( _pages, {
                                                __data_navigate: false,
                                                populateMaster: function ( row ) {
                                                    return _iWorker.populateMaster.call( this, row, $( '[data-field-key]', $elm ) );
                                                },
                                                print_preview: function ( id, val ) {
                                                    let out_opt = typeof ( id ) === "function" ? id.call( this ) : this.reg.print_settings.call( this, id, val );
                                                    if ( typeof ( out_opt ) !== "object" )
                                                        throw new Error( "Invalid print_settings defined in print method....." );
                                                    _iWorker.print_preview( out_opt );
                                                    return this;
                                                },
                                                print: function ( cb, index ) {
                                                    if ( typeof ( this.reg.print_settings ) !== "function" ) {
                                                        cb.call( this, "ERROR" );
                                                        return;
                                                    }
                                                    if ( !index )
                                                        index = this.reg.info.primary_key.value;
                                                    ...
                                                    _iWorker.confirm( {
                                                        content: String.format( 'Are you sure to Print <b style="font-size:14px">{0}</b> ?', index ),
                                                        confirm: function () {
                                                            let out_opt = _pages.reg.print_settings.call( _pages, _pages.reg.info.primary_key.id, index );
                                                            if ( typeof ( out_opt ) !== "object" )
                                                                throw new Error( "Invalid print_settings defined in print method....." );
                                                            _iWorker.print_preview( out_opt );
                                                ...
                                                getSearchObj: function ( $inst ) {
                                                    return _iWorker.getSearchObj( ( $inst instanceof $ ) ? $inst : $( '[data-field-key][data-search="true"]', $elm ), "object" );
                                                },
                                                clean: function ( cb ) {
                                                    if ( typeof ( cb ) !== 'function' )
                                                        cb = function () { };
                                                    let ctype = typeof ( this.reg.toolbar.clean ) === "object";
                                                    if ( ctype ) {
                                                        if ( typeof ( this.reg.toolbar.clean.before ) === "function" )
                                                            this.reg.toolbar.clean.before.call( this );
                                                    }
                                                    ...
                                                    if ( ctype ) {
                                                        if ( typeof ( this.reg.toolbar.clean.after ) === "function" )
                                                            this.reg.toolbar.clean.after.call( this );
                                                    }
                                                    cb.call( this, "SUCCESS" );
                                                    return this;
                                                },
                                                save: function ( cb, formobj, cmsg ) {
                                                    if ( typeof ( formobj ) === "undefined" ) {
                                                        formobj = _iWorker.validate.all( $( '[data-field-key]', $elm ) );
                                                        if ( formobj === null ) {
                                                    ...
                                                    //
                                                    _iWorker.confirm( {
                                                        content: cmsg || String.format( 'Are you sure to {0} this document {1}?', ( isUpdate === true ? "Update" : "Save" ), ( isUpdate === true ? ( ", App Id#" + this.reg.info.primary_key.value ) : "" ) ),
                                                        confirm: function () {
                                                            Sow.loader.show();
                                                            _iWorker.xhr.post( {
                                                                def: {
                                                                ...
                                                                conf: _pages.cmd.iu,
                                                                    ...
                                                                    formobj = undefined;
                                                                    Sow.Show.s( data.ret_msg || "Data has been Saved." );
                                                                    if ( !isUpdate ) {
                                                                        _pages.clean();
                                                                    }
                                                                    cb.call( _pages, "SUCCESS", data.ret_val, isUpdate ); return;
                                                                },
                                                ...
                                                search: function ( cb, obj ) {
                                                    if ( _pages._navigator ) {
                                                        ...
                                                        if ( _pages.reg.info.has_detail ) {
                                                            let $dtable = $( '[data-body-part="result"] table', $elm );
                                                            if ( $dtable.length > 0 ) {
                                                                if ( _pages.reg.info.search_detail.tablesorter === true ) {
                                                                    if ( typeof ( $dtable[0].tablesorter_destroy ) === "function" ) {
                                                                        $dtable[0].tablesorter_destroy();
                                                                    } else {
                                                                        $dtable.remove(); $dtable.exit();
                                                                    }
                                                                } else {
                                                                    $dtable.remove(); $dtable.exit();
                                                                }
                                                    ...
                                                    if ( _pages.cmd.s.type === "SQL" ) {
                                                        ...
                                                        let sql = ( typeof ( _pages.cmd.s.sql ) === "function" ?
                                                            _pages.cmd.s.sql.call( _pages, typeof ( obj ) === "object", obj )
                                                            : _pages.cmd.s.sql.replace( /\r\n/gi, "" ).replace( /\n/gi, "" ).replace( /\\t/gi, " " ).replace( /\s+/g, " " )
                                                        );
                                                        if ( typeof ( sql ) !== "string" )
                                                            throw new TypeError( "SQL should be string!!!" );
                                                    ...
                                                    return _iWorker.xhr.post( {
                                                        ...
                                                        conf: {
                                                            ...
                                                            if ( typeof ( _pages.__on_search_data_modify ) === "function" )
                                                                data = _pages.__on_search_data_modify( data );
                                            ...
                                            for ( let p in _pages.fm ) {
                                                ...
                                                if ( 'function' === typeof ( inf.external_link ) ) {
                                                    ...
                                                    if ( typeof ( ex_link_s ) !== "object" )
                                                        throw new TypeError( "external_link settings are missing in " + inf.name );
                                                    _pages.children[inf.name] = ex_link_s;
                                                }
                                                if ( inf.t !== 'dropdown' ) continue;
                                                if ( inf.source === "OWN" ) {
                                                    if ( inf.drop_type === "selectize" )
                                                        _pages.set_dispose_prop( inf.name, inf.drop_type );
                                                    continue;
                                                };
                                                if ( typeof ( inf.source ) === 'function' )
                                                    inf.source = inf.source.call( _pages, _pages.require );
                                                if ( typeof ( inf.source ) !== 'object' )
                                                    throw new TypeError( String.format( "Invalid source type defined instead of Object for ==>{0}", inf.name ) );
                                            ...
                                            if ( $.isArray( _pages.reg.event_arry ) ) {
                                                for ( let i = 0, l = _pages.reg.event_arry.length; i < l; i++ ) {
                                                    ...
                                                    if ( 'undefined' === typeof ( name ) )
                                                        throw new TypeError( 'Invalid event name defined!!!' );
                                            ...
                                            $( '[data-switch="true"]', $elm ).on( 'click', function ( e ) {
                                                ...
                                                Sow.hook( _pages.reg.key ).firea( "_on_data_switch", $input, val, function () {
                                                    $input.exit(); $input = undefined;
                                                } );
                                            } );
                                            $( '[data-widget="custom_jarvisWidgets"] [data-placement="bottom"]', $elm ).on( "click", function ( e ) {
                                                e.preventDefault();
                                                let $own = $( this );
                                                let $cont = $( $own.attr( "data-ref-id" ) );
                                                let cp = $own.attr( "data-original-title" ) === "Collapse";
                                                if ( cp ) {
                                                    $own.attr( "data-original-title", "Expend" );
                                                    $own.find( "i" ).removeClass( "fa-plus" ).addClass( "fa-minus" );
                                                    $cont.removeClass( "jarviswidget-collapsed" );
                                                } else {
                                                    $own.attr( "data-original-title", "Collapse" );
                                                    $own.find( "i" ).removeClass( "fa-minus" ).addClass( "fa-plus" );
                                                    $cont.addClass( "jarviswidget-collapsed" );
                                                }

                                                let $loader = $( '.jarviswidget-loader', $cont );
                                                $loader.fadeIn( "slow" );
                                                let $wbody = $( '[role="content"]', $cont );
                                                $wbody.slideToggle( "slow", function () {
                                                    $wbody.css( "display", cp === true ? "" : "none" );
                                                } );
                                                $loader.fadeOut( "slow" );
                                                $own = $cont = $loader = void 0;
                                            } );
                                            ...
                                            if ( _pages.reg.toolbar ) {
                                                if ( _pages.reg.toolbar.disabled === true ) {
                                                    ...
                                                    if ( typeof ( _pages.reg.toolbar.buttons ) === 'object' ) {
                                                        ...
                                                        delete _pages.reg.toolbar.buttons;
                                                    }
                                                    if ( typeof ( _pages.reg.toolbar.disabledButtons ) === 'object' ) {
                                                        $( ".__tools [data-name]", $elm ).each( function () {
                                                            let $towner = $( this );
                                                            let nm = $towner.attr( "data-name" );
                                                            if ( _pages.reg.toolbar.disabledButtons.indexOf( nm ) > -1 )
                                                                $towner.remove();
                                                            $towner.exit(); $towner = undefined;
                                                        } );
                                                        delete _pages.reg.toolbar.disabledButtons;
                                                    }
                                            ...
                                            if ( _pages.source.param.length > 0 ) {
                                                _pages.loadDropDown( function () {
                                                    ...
                                                    Sow.hook( "__web__page" ).firea( "__on_render", route );
                                                    //if ( _query.param[_pages.reg.info.primary_key.id] ) {
                                                    if ( Object.keys( _query.param ).length > 0 && typeof ( _pages.cmd.s.sp ) !== "undefined" ) {
                                ...
                                dispose: function ( route, cb ) {
                                    ...
                                    if ( Object.keys( page ).length > 0 ) {
                                        ...
                                        if ( typeof ( page.onDispose ) === 'function' ) {
                                            try { page.onDispose(); } catch ( e ) { console.elog( e ); }
                                        }
                                        Sow.hook.remove( page.reg.key );
                                        if ( typeof ( page.postmortem ) === 'function' ) {
                                            try { page.postmortem(); } catch ( e ) { console.elog( e ); }
                                        }
                                    }
                                    page = undefined;
                            ...
                            var __worker = {
                                prepare: function ( o, a, name, prop ) {
                                    if ( 'object' !== typeof ( o ) )
                                        throw new TypeError( "Invalid instance defined instead of Object" );
                                    let p = Object.keys( o )[0];
                                    if ( 'undefined' === typeof ( p ) )
                                        throw new TypeError( "No poperty key defined in Object" );
                                    prop = prop === void 0 || !prop ? "tab" : prop;
                                    let info = typeof ( o[p] ) === "function" ? o[p]() : o[p];
                                    info.name = p;
                                    if ( "undefined" === typeof ( info.sql ) ) info.sql = info.name;
                                    if ( name ) info[prop] = name;
                                    a.push( info );
                                    return {
                                        p: p,
                                        v: info
                                ...
                                render: this.aggregate( function () {
                                    var p_worker = {
                                        ...
                                        switch: function ( info ) {
                                            ...
                                            let texta = info.text ? info.text.split( "|" ) : ["ON", "OFF"];
												...
												<div class="form-group has-feedback{1}">
													...
													<span class="onoffswitch">
														...
														<label class="onoffswitch-label" for="{2}">
															<span class="onoffswitch-inner" data-switch="true" data-swchon-text="{10}" data-swchoff-text="{11}">
                                        ...
                                        writeNav: function ( $tab, $container, tArr, cObj ) {
                                            ...
                                            for ( let x in tArr ) {
                                                ...
                                                if ( cObj[x] ) {
                                                    content += '<div id="' + x + '" class="tab-pane fade ' + ( content === "" ? "in active" : "" ) + '">' + cObj[x].html + "</div>";
                                                }
                                    ...
                                    return {
                                            ...
                                            var getHtml = function ( arr ) {
                                                ...
                                                for ( let i = 0, l = arr.length; i < l; i++ ) {
                                                    ...
                                                    if ( typeof ( p_worker[info.t] ) !== 'function' )
                                                        throw new TypeError( String.format( "Invalid method defined==>{0}", info.t ) );
                                            ...
                                            return {
                                                header: function ( header, tabHeaderArr, $tab, $container ) {
                                                    if ( !$.isPlainObject( header ) )
                                                        throw new TypeError( '"this header" is not instanceof Object' );
                                                    if ( !$.isArray( tabHeaderArr ) )
                                                        throw new TypeError( '"this tabHeaderArr" is not instanceof Array' );

                                                    if ( !__worker.instanceOf( $tab ) )
                                                        throw new TypeError( '"this $tab" is not instanceof jQuery' );

                                                    if ( !__worker.instanceOf( $container ) )
                                                        throw new TypeError( '"this $container" is not instanceof jQuery' );
                                                ...
                                                footer: function ( footer, tabFooterArr, $tab, $container ) {
                                                    if ( !$.isPlainObject( footer ) )
                                                        throw new TypeError( '"this footer" is not instanceof Object' );
                                                    if ( !$.isArray( tabFooterArr ) )
                                                        throw new TypeError( '"this tabFooterArr" is not instanceof Array' );
                                        ...
                                        widget: this.aggregate( function () {
                                            var widget_template = `<div id="wid-id-{0}" class="jarvis_widget jarviswidget jarviswidget-color-darken{1}jarviswidget-sortable" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-collapsed="{6}" role="widget">
                                                                      <header role="heading" class="ui-sortable-handle" style="height:31.5px!important">
                                                                         <div class="jarviswidget-ctrls" role="menu">
                                                                            <a href="javascript:void(0);" data-ref-id="#wid-id-{0}" style="color:white" class="button-icon jarviswidget-toggle-btn" rel="tooltip" title="{7}" data-placement="bottom"><i class="fa {2}"></i></a>
                                                                         </div>
                                                ...
                                                ;
                                            var get_html = function ( arr, key ) {
                                                if ( !arr || typeof ( arr ) !== "object" )
                                                    throw new TypeError( "Invalid object defined instead of Array!!!" );
                                                let out = {
                                                    html: "",
                                                    r: 0
                                                };
                                                ...
                                                arr = undefined;
                                                return out.html.replace( /\t/gi, "" ).replace( /\n/gi, "" ).replace( /\s+/g, " " );
                                            };
                                            return {
                                                header: function ( settings, headerArr, $container ) {
                                                    if ( !$.isArray( headerArr ) )
                                                        throw new TypeError( '"this headerArr" is not instanceof Array' );
                                                    ...
                                                    if ( headerArr.length <= 0 ) {
                                                        ...
                                                        let $widget = $( String.format( '<section id="{0}" data-widget="custom_jarvisWidgets"></section>', Math.random().toString( 36 ).replace( ".", "" ) ) );
                                                        //$container.html( "" );
                                                        let is_first = true;
                                                        for ( let prop in settings ) {
                                                            let set = {
                                                                cls: settings[prop].collapse === false ? " " : " jarviswidget-collapsed ",
                                                                fnt: settings[prop].collapse === false ? "fa-minus" : "fa-plus",
                                                                sty: settings[prop].collapse === false ? "" : ' style="display: none;"',
                                                                attr: settings[prop].collapse === false ? "Expend" : "Collapse"
                                                            }
                                                            if ( is_first === false ) {
                                                                $widget.append( "<div><ul></ul></div>" );
                                                            } else {
                                                                is_first = false;
                                                            }
                                                            $widget.append( String.format(
                                                                widget_template,
                                                                Math.random().toString( 36 ).replace( ".", "" ),
                                                                set.cls, set.fnt,
                                                                settings[prop].title, set.sty,
                                                                get_html( headerArr, prop ),
                                                                settings[prop].collapse,
                                                                set.attr
                                                            ) );
                                                            set = void 0;
                                                        }
                                                        $container.html( $widget );
                                                        $widget.exit(); $widget = void 0;
                                                    }
                                                    settings = headerArr = $container = void 0;
                                                    return this;
                                                },
                                                footer: function ( settings, footerArr, $container ) {
                                                    if ( !$.isArray( footerArr ) )
                                                        throw new TypeError( '"this footerArr" is not instanceof Array' );
                                                    ...
                                                    settings = footerArr = $container = void 0;
                                                    return __worker;
                                                }
                                            };
                                        } ),
                                        body: this.aggregate( function () {
                                            var get_html = function ( arr ) {
                                                if ( !arr || typeof ( arr ) !== "object" )
                                                    throw new TypeError( "Invalid object defined instead of Array!!!" );
                                                let out = {
                                                    html: "",
                                            ...
                                            return {
                                                header: function ( headerArr, $container ) {
                                                    ...
                                                    if ( headerArr.length <= 0 ) {
                                                        ...
                                                        $container.html( get_html( headerArr ) );
                                                    }
                                                ...
                                                footer: function ( footerArr, $container ) {
                                                    ...
                                                    if ( footerArr.length <= 0 ) {
                                                        ...
                                                        $container.html( get_html( footerArr ) );
                                                    }
                            ...
                            return {
                                render: function ( fm, $elm ) {
                                    if ( !__worker.instanceOf( $elm ) )
                                        throw new TypeError( "Invalid jQuery instance defined!!!" );

                                    if ( !$.isPlainObject( fm ) )
                                        throw new TypeError( "Invalid Object instance defined!!!" );
                                    ...
                                    if ( typeof ( fm.header ) === "function" ) fm.header();
                                    if ( $.isArray( fm.header ) ) {
                                        fm.header.find( function ( o ) {
                                            let resp = __worker.prepare( o, fild_map.header );
                                    ...
                                    if ( typeof ( fm.footer ) === "function" ) fm.footer();
                                    if ( $.isArray( fm.footer ) ) {
                                        fm.footer.find( function ( o ) {
                                            let resp = __worker.prepare( o, fild_map.footer );
                                            __inf.fields[resp.p] = resp.v;
                                            if ( typeof ( resp.v.sql_def ) === 'function' )
                                                __inf.sql_def[resp.p] = resp.v.sql_def;
                                            return false;
                                    ...
                                    if ( fm.widget && typeof ( fm.widget ) === "object" ) {
                                        fm.widget.settings = {
                                            header: {},
                                            footer: {}
                                        };
                                        if ( typeof ( fm.widget.header ) === "function" ) fm.widget.header();
                                        if ( $.isArray( fm.widget.header ) ) {
                                            fm.widget.header.find( function ( o ) {
                                                if ( $.isArray( o.fields ) ) {
                                                    o.fields.find( function ( r ) {
                                                        let resp = __worker.prepare( r, fild_map.widget_header, o.key, "widget" );
                                                        __inf.fields[resp.p] = resp.v;
                                                        if ( typeof ( resp.v.sql_def ) === 'function' )
                                                            __inf.sql_def[resp.p] = resp.v.sql_def;
                                                    } );
                                                    fm.widget.settings.header[o.key] = {
                                                        title: o.title,
                                                        collapse: o.collapse
                                                    };
                                                }
                                            ...
                                            delete fm.widget.header;
                                        }
                                        if ( typeof ( fm.widget.footer ) === "function" ) fm.widget.footer();
                                        if ( $.isArray( fm.widget.footer ) ) {
                                            fm.widget.footer.find( function ( o ) {
                                                if ( $.isArray( o.fields ) ) {
                                                    o.fields.find( function ( r ) {
                                                        let resp = __worker.prepare( r, fild_map.widget_footer, o.key );
                                                        __inf.fields[resp.p] = resp.v;
                                                        if ( typeof ( resp.v.sql_def ) === 'function' )
                                                            __inf.sql_def[resp.p] = resp.v.sql_def;
                                                    } );
                                                    fm.widget.settings.footer[o.key] = {
                                                        title: o.title,
                                                        collapse: o.collapse
                                                    };
                                                }
                                    ...
                                    if ( typeof ( fm.widget.settings ) !== "object" ) {
                                        fm.widget.settings = {
                                            header: {},
                                            footer: {}
                                        };
                                    }
                                    if ( typeof ( fm.widget.settings.header ) !== "object" ) fm.widget.settings.header = {};
                                    if ( typeof ( fm.widget.settings.footer ) !== "object" ) fm.widget.settings.footer = {};
                                    let tabs = {
                                        header: {},
                                        footer: {}
                                    };
                                    if ( typeof ( fm.tabs.header ) === "function" ) fm.tabs.header();
                                    if ( $.isArray( fm.tabs.header ) ) {
                                        fm.tabs.header.find( function ( o ) {
                                            if ( $.isArray( o.fields ) ) {
                                                o.fields.find( function ( r ) {
                                                    let resp = __worker.prepare( r, fild_map.tab_header, o.key );
                                                    __inf.fields[resp.p] = resp.v;
                                                    if ( typeof ( resp.v.sql_def ) === 'function' )
                                                        __inf.sql_def[resp.p] = resp.v.sql_def;
                                                } );
                                    ...
                                    if ( typeof ( fm.tabs.footer ) === "function" ) fm.tabs.footer();
                                    if ( $.isArray( fm.tabs.footer ) ) {
                                        fm.tabs.footer.find( function ( o ) {
                                            if ( $.isArray( o.fields ) ) {
                                                o.fields.find( function ( r ) {
                                                    let resp = __worker.prepare( r, fild_map.tab_footer, o.key );
                                                    __inf.fields[resp.p] = resp.v;
                                                    if ( typeof ( resp.v.sql_def ) === 'function' )
                                                        __inf.sql_def[resp.p] = resp.v.sql_def;
                                                } );
                                    ...
                                    ( function () {
                                        ...
                                        this.tab.header( tabs.header, fild_map.tab_header, $inst.find( '.nav.nav-tabs' ), $inst.find( '.tab-content' ) );
                                        this.body.header( fild_map.header, $inst.find( '[data-body="header"]' ) );
                                        this.widget.header( fm.widget.settings.header, fild_map.widget_header, $inst.find( '[data-body="widget"]' ) );
                                        $inst.exit(); $inst = undefined;
                                        $inst = $( '[data-body-part="footer"]', $elm );
                                        this.tab.footer( tabs.footer, fild_map.tab_footer, $inst.find( '.nav.nav-tabs' ), $inst.find( '.tab-content' ) );
                                        this.widget.footer( fm.widget.settings.footer, fild_map.widget_footer, $inst.find( '[data-body="widget"]' ) );
                                        this.body.footer( fild_map.footer, $inst.find( '[data-body="footer"]' ) );
                                        $inst.exit();
                                        for ( let x in tabs ) delete tabs[x];
                                        $inst = tabs = undefined;
                                    }.call( __worker.render ) );
                                    for ( let x in fm ) delete fm[x];
                                    for ( let x in fild_map ) delete fild_map[x];
                                    fm = fild_map = undefined;
                                    return __inf;
                                }
                            };
                        } )
    ...
    Sow.define( "Sow.Net.Web.Page.Renderer", function () {
        ...
        return {
            errorResponse: function ( errorCode, $container, oldResponse, cb ) {
                ...
                if ( ["401", "403", "404", "500", "505"].indexOf( errorCode ) <= -1 ) errorCode = "apperror";
                $.ajax( {
                    type: "GET",
                    ...
                    cb.call( Sow, $container );
                    console.log( xres.status_description || thrownError );
                    cb = $container = oldResponse = undefined;
                } );
            },
            ...
            get_route_ctx: _instance.renderer.get_route_ctx,
