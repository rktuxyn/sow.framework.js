                                        ...
                                        this.getTemplate( __pages[route].reg.template, function ( s, d ) {
                                            ...
                                            Object.extend( _pages, {
                                                ...
                                                save: function ( cb, formobj ) {
                                                    ...
                                                    //
                                                    _iWorker.confirm( {
                                                        content: String.format( 'Are you sure to {0} this document {1}?', ( isUpdate === true ? "Update" : "Save" ), ( isUpdate === true ? ( ", App Id#" + this.reg.info.primary_key.value ) : "" ) ),
                                                        confirm: function () {
                                                            Sow.loader.show();
                                                            _iWorker.xhr.post( {
                                                                def: {
