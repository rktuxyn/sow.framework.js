                ...
                return {
                    script: module.aggregate( function () {
                        ...
                        var s_worker = module.aggregate( function () {
                            ...
                            return {
                                storage: {
                                    set: function ( identity, func ) {
                                        if ( typeof ( func ) !== "function" )
                                            throw new TypeError( "Invalid argument defined instead of function!!!" );
                                        if ( this.has( identity ) )
                                            delete __storage[identity];
                                        __storage[identity] = func;
                                        return this;
                                    },
                        ...
                        return {
                            ...
                            remove: function ( identity ) {
                                ...
                                $( '[data-page-model-script="' + identity + '"]' ).remove();
                                return this;
                            },
                            run: function ( identity, data, cb ) {
                            ...
                            register: function ( identity, func ) {
                                s_worker.storage.set( identity, func );
                                return this;
                            },
                            parse: function ( identity, text, cb ) {
                                ...
                                require( "parser" ).init( identity, text, function ( script ) {
                                    script = "Sow.Web.Template.script.register('" + identity + "', function(__data, __cb){\r\n" + script + "\r\n});\r\n";
                                    let $elm = $( "<script>" );
                                    $elm.attr( "type", "text/javascript" )
                                    $elm.attr( "data-page-model-script", identity );
                                    var me = this;
                                    $elm.on( "load", function ( e ) {
                                        let b = $elm.attr( "src" );
                                        URL.revokeObjectURL( b );
                                        $elm.remove(); $elm.exit(); $elm = undefined;
                                        cb.call( me, "DONE" ); me = undefined;
                                    } ).on( "error", function ( e ) {
                                        let b = $elm.attr( "src" );
                                        URL.revokeObjectURL( b );
                                        console.elog( e );
                                        cb.call( me, "ERROR" ); $elm.remove(); $elm.exit(); $elm = me = undefined;
                                    } );
                        ...
                        return function ( identity, script, callback ) {
                            ...
                            let __worker = {
                                execute: function ( start, max ) {
                                    ...
                                    __worker = ilen = line = isTagStart = isTagEnd = tag1 = tag2 = tag3 = tag4 = set = _get = script = undefined;
                                    out += "/** ** [/END STRIPE-" + ( i + 1 - 1 ) + "] ** **/\r\n/** ** [END CLIENT SCRIPT]** **/";
                                    out = out.replace( /__RSP \+\= '';/g, '' );
                                    i = undefined;
                                    out += '\ntypeof( __cb )==="function" ? __cb.call(this, __RSP):undefined;\n';
                                    out += "__RSP = undefined;\n";
                                    if ( typeof ( callback ) !== 'function' ) return out;
                                    callback.call( require( "owner" ).script, out ); out = undefined;
